...
| FIAPx | Site com diversos cursos gratuitos na área da tecnologia. | [Link](https://www.fiap.com.br/fiapx) |
...
| HTML CSS JS Generator | Gerador de HTML/CSS/JS. | [Link](https://html-css-js.com/css/generator/) |
...
| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| 99freelas | Encontre o melhor profissional freelancer. | [Link](https://www.99freelas.com.br/) |
| BairesDev | Acelere sua transformação digital. | [Link](https://www.bairesdev.com) |
| Coodesh | Conectamos developers validados às empresas. | [Link](https://coodesh.com) |
| Fiverr | Encontre os serviços freelance perfeitos para o seu negócio. | [Link](https://www.fiverr.com/) |
| Freelancer | Contrate os melhores freelancers para qualquer trabalho, tudo isso online. | [Link](https://www.br.freelancer.com/) |
| Freelaweb | Os melhores freelancers, encontre o serviço ideal para se projeto! | [Link](https://freelaweb.com.br/) |
| ❤️ Glassdoor | Encontre o emprego perfeito para você. | [Link](https://www.glassdoor.com.br/index.htm) |
| Há Vagas | Hoje temos 350 novas vagas. | [Link](https://havagas.pt) |
| Hired | Empregue seu potencial. | [Link](https://hired.com) |
| ❤️ Indeed | O Indeed é o site de empregos número 1 do mundo, com mais de 250 milhões de visitantes únicos por mês. O Indeed está presente em mais de 60 países e 28 idiomas, abrangendo 94% do PIB mundial. | [Link](https://br.indeed.com/) |
| JustRemote | Trabalhos remotos que se adaptam à sua vida. Descubra trabalhos remotos total e parcialmente das maiores empresas de trabalho remoto. | [Link](https://justremote.co) |
| PeoplePerHour | Acesse talentos globais no site de freelancer confiável por mais de 1 milhão de empresas em todo o mundo. | [Link](https://www.peopleperhour.com/) |
| Remote OK | Trabalhe em qualquer lugar, more em qualquer lugar #OpenSalaries. | [Link](https://remoteok.io) |
| Toptal | Talento freelance confiável, pronto para se juntar à sua equipe. | [Link](https://www.toptal.com) |
| Turing | Acelere sua equipe dos sonhos de engenharia. | [Link](https://www.turing.com) |
| Upwork | Encontre as melhores pessoas para o seu trabalho. | [Link](https://www.upwork.com/) |
...
| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| .NET Fiddle | Codifique e compartilhe projetos C# online. | [Link](https://dotnetfiddle.net/) |
| 1PageRank | Ranqueie seu site nos mecanismos de buscas e aprenda com a concorrência. | [Link](http://www.1pagerank.com/) |
| 4Devs | Ferramentas online gratuitas, geradores de cpf, conta bancária, pessoas, CNPJ, CEP, RG, validadores, encoders e muitas outras. | [Link](https://www.4devs.com.br/) |
| ❤️ Any API | Diretório gratuito com APIs públicas. | [Link](https://any-api.com/) |
| Autoprefixer CSS | Transpile código CSS atual para código CSS com maior cobertura de navegadores antigos. | [Link](http://autoprefixer.github.io/) |
| Browser diet | Guia de performance para desenvolvimento web. | [Link](https://browserdiet.com/pt/) |
| Bundlephobia | Descubra o custo de adicionar um pacote npm ao seu pacote. | [Link](https://bundlephobia.com) |
| Can I email... | Descubra o que do HTML e CSS pode ser usado em estruturas de e-mail. | [Link](https://www.caniemail.com/) |
| Can I use... | Descubra se você pode usar determinadas tecnologias web. | [Link](https://caniuse.com/) |
...
| Hover Effects | Uma coleção de efeitos de foco com CSS3 para serem aplicados a links, botões, logotipos, SVG, imagens em destaque e assim por diante. - Esta é uma lista de projetos que selecionaram tarefas especificamente para novos colaboradores. | [Link](https://ianlunn.github.io/Hover/) |
...
| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Sharpen | Sharpen gera prompts de projetos abertos que reforçam a resolução de problemas críticos, a curiosidade e a criatividade em 21 categorias diferentes e 2 geradores exclusivos. | [Link](https://sharpen.design/) |
| Daily UI | Torne-se um designer melhor em 100 dias. | [Link](https://www.dailyui.co/) |
| UX Challenges | Pratique com exercícios do mundo real. | [Link](https://uxtools.co/challenges) |
| Drawerrr | Um desafio de design de produto. | [Link](https://drawerrr.com/challenge) |
| Uplabs | Explore nossos desafios abertos e envie seu trabalho! | [Link](https://www.uplabs.com/challenges) |

## ☁ Ferramentas para hospedar seu site.

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| 1FreeHosting | Hospedagem de sites grátis com 100GB de largura de banda | [Link](http://www.1freehosting.com/) |
| ❤️ Amazon Web Services | Serviço de aluguel de servidores e outros serviços | [Link](https://aws.amazon.com/pt/) |
| Award Space | Hospedagem gratuita na web + um subdomínio gratuito, PHP, MySQL, instalador de aplicativo, envio de e-mail e sem anúncios | [Link](https://www.awardspace.com/) |
| BlueHost | Empresa americana de hospedagem de sites | [Link](https://www.bluehost.com/) |
| Byet | Hospedagem Gratuita e Serviços de Hospedagem Premium. | [Link](https://byet.host/) |
| DigitalOcean | Aluguel de servidores dedicados e compartilhados | [Link](https://www.digitalocean.com/) |
| DreamHost | Hospedagem de sites de alta disponibilidade | [Link](https://www.dreamhost.com/) |
| Embratel | Hospedagem de sites nacional | [Link](https://www.embratel.com.br/cloud/hospedagem-de-sites) |
| ❤️ Github Pages | Hospedado diretamente de seu repositório GitHub. Basta editar, enviar e suas alterações entrarão em vigor | [Link](https://pages.github.com/) |
...
| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Bootstrap icons | Biblioteca de ícones de código aberto gratuita e de alta qualidade com mais de 1.600 ícones. Inclua-os da maneira que quiser - SVGs, sprite SVG ou fontes da web. Use-os com ou sem Bootstrap em qualquer projeto. | [Link](https://icons.getbootstrap.com/) |
| Devicon | Devicon é um conjunto de ícones que representam linguagens de programação, design e ferramentas de desenvolvimento. Você pode usá-lo como fonte ou copiar/colar diretamente o código SVG em seu projeto. | [Link](https://devicon.dev/) |
| Eva Icons | Um pacote de mais de 480 ícones Open Source lindamente criados para ações e itens comuns. | [Link](https://akveo.github.io/eva-icons/#/) |
| Feather Icons | Ícones de código aberto simplesmente lindos | [Link](https://feathericons.com/) |
| Flaticon | Acesse mais de +7.8M ícones vetoriais e figurinhas | [Link](https://www.flaticon.com/br/) |
| ❤️ Font Awesome | Elimine o incômodo dos ícones em seu site. | [Link](https://fontawesome.com) |
| Heroicons | Ícones licenciados pelo MIT por @steveschoger | [Link](https://heroicons.dev/) |
| Iconfinder | Iconfinder é uma empresa web cujo principal produto é um buscador de ícones. | [Link](https://www.iconfinder.com/) |
| Iconmonstr | Descubra mais de 4699 ícones gratuitos em 316 coleções | [Link](https://iconmonstr.com/) |
| ❤️ Icons8 | Ícones, ilustrações, fotos, músicas e ferramentas de design | [Link](https://icons8.com.br/) |
| Icons8 Line Awesome | Troque o Font Awesome por ícones de linha modernos em uma linha de código. | [Link](https://icons8.com/line-awesome/) |
| Iconsvg | Ícones personalizáveis rápidos para seus projetos | [Link](https://iconsvg.xyz/) |
| ❤️ Lord Icon | Biblioteca de ícones animados cuidadosamente criados, prontos para uso em produtos digitais, apresentações ou vídeos! | [Link](https://phosphoricons.com) |
| Noun Project | Ícones e fotos para tudo | [Link](https://thenounproject.com/) |
| Phosphor Icon | Família flexível de ícones com integração HTML/CSS, React e Vue | [Link](https://phosphoricons.com) |
| Reshot | Crie livremente com downloads instantâneos e licenças comerciais. | [Link](https://www.reshot.com/) |
| Shape | 36.600 ícones e ilustrações totalmente personalizáveis | [Link](https://shape.so/) |
| Vertex | Ícones 3D gratuitos, totalmente personalizáveis online | [Link](https://phosphoricons.com) |
...
| Torne-se um Programador - Danilo Aparecido | Canal com + de 500 aulas e dicas sobre programação e negócios com programação. | [Link](https://www.youtube.com/c/DaniloAparecido) |
| Traversy Media | Traversy Media apresenta os melhores tutoriais de desenvolvimento e programação da web on-line para todas as tecnologias da web mais recentes. | [Link](https://youtube.com/c/TraversyMedia) |
| UnicornCoder | Videos de programação e cursos. | [Link](https://www.youtube.com/c/KaSolutionOficial/) |
| ❤️ Universo Programado | Canal sobre lógica por trás do desenvolvimento de inteligências artificiais. | [Link](https://www.youtube.com/channel/UCf_kacKyoRRUP0nM3obzFbg) |
| ❤️ VegaData | Aqui temos vários conteúdos relacionados a Tecnologia em Geral, Principalmente para os Entusiastas do Mundo Android. | [Link](https://www.youtube.com/c/VegaData) |
| Vida de Programador | Conteúdo sobre tecnologia e programação. | [Link](https://www.youtube.com/c/ProgramadorREAL) |
| Vinícius Thiengo | Canal com aulas de desenvolvimento android e técnicas de código limpo. | [Link](https://www.youtube.com/c/ThiengoCalopsita/) |
| Web Dev Simplified | Web Dev Simplified tem tudo a ver com o ensino de habilidades e técnicas de desenvolvimento web de maneira eficiente e prática. | [Link](https://www.youtube.com/c/WebDevSimplified/) |
| ❤️ Willian Justen | Um Screencast focado em Desenvolvimento Web, abordando assuntos como HTML, CSS, JS, SVG, React, Canvas, Acessibilidade e muito mais. | [Link](https://www.youtube.com/c/WillianJustenCursos) |
| zer01ti | Novidades da tecnológica | [Link](https://www.youtube.com/c/zero1ti/) |
| Zero Bugs | Canal sobre desenvolvimento web com PHP e JavaScript. | [Link](https://www.youtube.com/c/ZeroBugs) |
| ZUP | Canal sobre tecnologia. | [Link](https://www.youtube.com/c/ZUPIT/) |
...
| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Beef-Project | Framework de exploração de browser. | [Link](https://beefproject.com/) |
| Capture The Flag - CTF | Desafios reais de hacking, desenvolvido por especialistas brasileiros. | [Link](https://capturetheflag.com.br/) |
| HackTheBox | Site com laboratórios para praticar pentest de forma gratuita e legal | [Link](https://www.hackthebox.eu/) |
| HStrike | Ferramentas de pentest em nuvem. | [Link](https://hstrike.com/) |
| HTTRack | Browser utility. | [Link](http://www.httrack.com/) |
| Maltego | Ambiente open source para análise de redes completa. | [Link](https://www.paterva.com/) |
| NMap | Scanner de portas de rede. | [Link](https://nmap.org/) |
| picoCTF | Jogo gratuito de segurança de computador voltado para alunos do ensino fundamental, médio e iniciantes. | [Link](https://picoctf.com/) |
| SQLMap | Ferramenta de teste de penetração open source que automatiza injeção de SQL. | [Link](http://sqlmap.org/) |

## 🎙 Blogs e Podcasts.

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Ambev Tech Talk | Podcast da Ambev sobre tecnologia e cerveja. | [Link](https://open.spotify.com/show/07cPNODgBHWh2JMkHbZxXG) |
| Boss Level | O Boss Level é um Podcast sobre desenvolvimento, Frontend, Backend e DevOps. | [Link](https://open.spotify.com/show/003zbichzSTjf3m7W2Sfvc) |
| Cabeça de Labs | O Cabeça de Lab é o podcast do Luizalabs, o laboratório de inovação e tecnologia do Magalu. | [Link](https://www.cabecadelab.com.br/) |
| Carreira sem Fronteiras | Podcast com brasileiros que vivem e trabalham no exterior. | [Link](https://www.carreirasemfronteiras.com.br/) |
| Codigo Aberto | Conversas com os profissionais mais influentes do mercado sobre o futuro. | [Link](https://www.b9.com.br/shows/codigoaberto/) |
| Cooperati | Site com algumas informações sobre tecnologia. | [Link](https://cooperati.com.br/) |
| Coruja de TI | Blog com várias dicas de TI no geral. | [Link](https://blog.corujadeti.com.br/) |
| ❤️ Dev.to | Rede social para desenvolvedores. | [Link](https://dev.to/) |
| DevNaEstrada | Desenvolvimento web em geral. | [Link](https://devnaestrada.com.br/) |
| Dicas de programação | Dicas para desenvolvedores. | [Link](https://dicasdeprogramacao.com.br/) |
| ❤️ DioCast | Tecnologia geral do canal DioLinux. | [Link](https://castbox.fm/app/castbox/player/id1323408) |
| É tudo nuve | Pesquisa. | [Link](https://www.etudonuve.com.br/i/) |
| FalaDev | Podcast da Rocketseat sobre desenvolvimento. | [Link](https://open.spotify.com/show/3TNsKUGlP9YbV1pgy3ACrW) |
| Fora da Norma | Podcast da 42SP sobre o universo Tech. | [Link](https://www.youtube.com/channel/UCPA5AzEp_MGEVTDSVCkgShg) |
| Fronteiras da Ciência | Ciência, pseudociências e tudo o mais, feito pelo IFUFGRS. | [Link](http://www.ufrgs.br/frontdaciencia/) |
| Hipsters.tech | Desenvolvimento de aplicações, design digital, startups e tecnologias em geral. | [Link](https://hipsters.tech/) |
...
| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Codecademy Android | Codecademy Go ajuda você a revisar e praticar o que aprendeu na web, em qualquer lugar, a qualquer hora. Aprenda a codificar de maneira fácil. | [Link](https://play.google.com/store/apps/details?id=com.ryzac.codecademygo&hl=pt_BR&gl=US) |
| Codecademy iOS | Codecademy Go ajuda você a revisar e praticar o que aprendeu na web, em qualquer lugar, a qualquer hora. Aprenda a codificar de maneira fácil. | [Link](https://apps.apple.com/us/app/codecademy-go/id1376029326) |
| ❤️ Dcoder Android | Dcoder é um IDE e plataforma de codificação móvel (Compilador para dispositivos móveis), onde você pode executar seus projetos, codificar e aprender algoritmos programando em dispositivos móveis. | [Link](https://play.google.com/store/apps/details?id=com.paprbit.dcoder&hl=pt_BR&gl=US) |
| GrassHopper Android | O Grasshopper é a melhor maneira de começar sua aventura na programação, com jogos divertidos e rápidos em seu celular que te ensinam a escrever JavaScript.| [Link](https://play.google.com/store/apps/details?id=com.area120.grasshopper&gl=US) |
| ❤️ Mimo Android | Avance na sua carreira, crie apps e sites ou se torne um desenvolvedor. Com o Mimo, você pode aprender a programar, a habilidade do século, alguns minutos por vez. | [Link](https://play.google.com/store/apps/details?id=com.getmimo&hl=pt_BR&gl=US) |
| Pydriod3 Android | O Pydroid 3 é o IDE educacional Python 3 mais fácil de usar e poderoso para Android. | [Link](https://play.google.com/store/apps/details?id=ru.iiec.pydroid3&hl=en_US&gl=US) |
| SoloLearn | A melhor maneira de aprender a codificar. | [Link](https://www.sololearn.com/home)|
