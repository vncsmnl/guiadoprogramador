...
## 📑 Sumário:
- [💡 Cursos de JavaScript](#-cursos-de-javascript)
- [🖼️ Cursos de HTML e CSS](#-cursos-de-html-e-css)
- [🐍 Cursos de Python](#-cursos-de-python)
- [🐘 Cursos de PHP](#-cursos-de-php)
- [👁️‍🗨️ Cursos de C](#-cursos-de-c-1)
- [💾 Cursos de C#](#-cursos-de-c)
- [📼 Cursos de C++](#-cursos-de-c-2)
- [☕ Cursos de Java](#-cursos-de-java)
- [🐀 Cursos de Camunda](#-cursos-de-camunda)
- [📲 Cursos de Kotlin](#-cursos-de-kotlin)
- [💫 Cursos de Swift](#-cursos-de-swift)
- [🐺 Cursos de Go](#-cursos-de-go)
- [💎 Cursos de Ruby](#-cursos-de-ruby)
- [🍷 Cursos de Elixir](#-cursos-de-elixir)
- [🌐 Cursos de React](#-cursos-de-react)
- [📱 Cursos de React Native](#-cursos-de-react-native)
- [📐 Cursos de Angular](#-cursos-de-angular)
- [🥬 Cursos de Vue](#-cursos-de-vue)
- [🦂 Cursos de Svelte](#-cursos-de-svelte)
- [🤳 Cursos de Flutter](#-cursos-de-flutter)
- [🌕 Cursos de jQuery](#-cursos-de-jquery)
- [🐢 Cursos de Less](#-cursos-de-less)
- [🐱 Cursos de Sass](#-cursos-de-sass)
- [🤖 Cursos de Bootstrap](#-cursos-de-bootstrap)
- [🔗 Linha de comando](#-linha-de-comando)
- [🐙 Cursos de Git e Github](#-cursos-de-git-e-github)
...
| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Curso completo de JavaScript (46 aulas) | Curso completo de Javascript. | [Link](https://goo.gl/zfjfkQ) |
| Curso de introdução ao JavaScript | Esse curso javascript iniciante é tanto para pessoas que nunca programaram antes e este curso de javascript completo gratis foi criado para você, que já sabe outra linguagem. | [Link](https://youtu.be/i6Oi-YtXnAU) |
| Curso JavaScript - Curso em Vídeo | O Curso em Vídeo e o Google apresentam um curso de JavaScript e ECMAScript para Iniciantes aqui no YouTube! | [Link](https://youtube.com/playlist?list=PLntvgXM11X6pi7mW0O4ZmfUI1xDSIbmTm) |
| Curso JavaScript | Neste super curso de JavaScript você vai aprender de forma fácil, clara e objetiva como programar e usar JavaScript para incrementar suas páginas Web. JavaScript é fundamental para quem quer seguir a carreira de desenvolvedor Web, seja front-end ou back-end. | [Link](https://youtube.com/playlist?list=PLx4x_zx8csUj3IbPQ4_X5jis_SkCol3eC) |
| Cursos de JavaScript em inglês | Javascript Course. | [Link](https://www.youtube.com/playlist?list=PLRAV69dS1uWSxUIk5o3vQY2-_VKsOpXLD) |
| Faça 15 Projetos em JavaScript (Inglês) | Build 15 JavaScript Projects - Vanilla JavaScript Course. | [Link](https://www.youtube.com/watch?v=3PHXvlpOkf4) |
| Fundamentos de JavaScript Funcional | Domine Função em JavaScript! Conteúdo essencial para todos os desenvolvedores! | [Link](https://www.cod3r.com.br/courses/javascript-funcional-fundamentos) |
| JavaScript - Dave Gray | JavaScript Full Course for Beginners Complete All-in-One Tutorial 8 Hours. | [Link](https://www.youtube.com/watch?v=EfAl9bwzVZk) |
| JavaScript - Florin Pop | 10 JavaScript Projects in 1 Hour - Coding Challenge 🔥 | [Link](https://www.youtube.com/watch?v=8GPPJpiLqHk) |
| JavaScript - Florin Pop | 10 JavaScript Projects in 10 Hours - Coding Challenge 🔥 | [Link](https://www.youtube.com/watch?v=dtKciwk_si4) |
| JavaScript - freeCodeCamp.org | JavaScript Programming - Full Course. | [Link](https://www.youtube.com/watch?v=jS4aFq5-91M) |
| JavaScript - freeCodeCamp.org | Learn JavaScript - Full Course for Beginners. | [Link](https://www.youtube.com/watch?v=PkZNo7MFNFg) |
| Playlist de projetos de JS | Javascript Real World Projects. | [Link](https://www.youtube.com/playlist?list=PLajjpPyc2dmbt0KebBvT9VQV8y2R_IO7j) |

## 🖼️ Cursos de HTML e CSS

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Curso Aprenda HTML em 1 hora (22 aulas) | Um curso completo sobre HTML 5 para quem quer aprender. Em apenas uma hora, aprenda tudo que você precisa saber pra começar a criar e desenvolver seus próprios sites. | [Link](https://goo.gl/1kfBCZ) |
| Curso completo de CSS3 (22 aulas) | Neste curso você aprenderá os conceitos básicos do CSS e o poder desta nova versão, enquadrando-se definitivamente em padrões mundiais de desenvolvimento web. Degradês, transições, animações, fontes externas, dicas e muito mais. | [Link](https://goo.gl/ebjzVG) |
| Curso Completo de HTML5 (42 aulas) | O curso de HTML5 visa apresentar os conceitos básicos do HTML e as principais mudanças e funcionalidades da quinta versão da linguagem. Um curso completo para todos os profissionais de web. | [Link](https://goo.gl/SD4p4g) |
| Curso completo e atual de HTML5 e CSS3 - Módulo 1 de 5 | Faça agora mesmo o Curso de HTML5 e CSS3 do Professor Gustavo Guanabara, com aulas atualizadas e com material de apoio em PDF. | [Link](https://www.youtube.com/playlist?list=PLHz_AreHm4dkZ9-atkcmcBaMZdmLHft8n) |
| Curso completo e atual de HTML5 e CSS3 - Módulo 2 de 5 | O segundo módulo do Curso em Vídeo de HTML5 e CSS3 vai trazer vários conceitos relacionados a design, aplicação de estilos em CSS e a criação de um projeto partindo do zero. | [Link](https://www.youtube.com/playlist?list=PLHz_AreHm4dlUpEXkY1AyVLQGcpSgVF8s) |
| Curso completo e atual de HTML5 e CSS3 - Módulo 3 de 5 | O terceiro módulo do Curso em Vídeo de HTML5 e CSS3 vai trazer vários conceitos relacionados a git, responsividade e at´r hospedagem de sites. | [Link](https://www.youtube.com/playlist?list=PLHz_AreHm4dmcAviDwiGgHbeEJToxbOpZ) |
| Curso de CSS3 - CFBCursos | Neste curso você irá aprender tudo que é necessário para usar o CSS3 de forma eficiente para formatar como quiser suas páginas web, com o CSS aliado ao HTML você vai criar qualquer layout que desejar em suas página web. | [Link](https://youtube.com/playlist?list=PLx4x_zx8csUi47Bnugpk78nqJN6rYvEnV) |
| Curso de CSS3 - Florin Pop | Construindo 10 Sites - Do Design ao HTML e CSS - Desafio de Codificação 🔥 | [Link](https://www.youtube.com/watch?v=Rz-rey4Q1bw&t) |
| Curso de CSS3 - Node Studio Treinamentos | Neste curso você aprenderá os conceitos básicos do CSS e o poder desta nova versão,  enquadrando-se definitivamente em padrões mundiais de desenvolvimento web. Degradês, transições, animações, fontes externas, dicas e muito mais. | [Link](https://youtube.com/playlist?list=PLwXQLZ3FdTVGf7GUtiOFLc_9AXO25iIzG) |
| Curso de CSS3 - WEB CIFAR | Projeto de site completo de uma página para prática. | [Link](https://www.youtube.com/watch?v=ZFQkb26UD1Y) |
| Curso de CSS3 com Sass e Compass (9 aulas) | Compass é um framework open source de criação de CSS que utiliza Sass para escrever o código de uma forma fácil e poderosa. | [Link](https://goo.gl/bAO0hE) |
| Curso em video | Material público para o ensino básico de HTML5 e CSS3 para alunos iniciantes. Acesse o material em PDF, analise o código disponibilizado para cada exercício e veja-os funcionando em execução direta via repositório GitHub. | [Link](https://github.com/gustavoguanabara/html-css) |
| HTML 5 Curso 1 | Curso completo de HTML5 Completo e Profissional, nesta playlist vou mostrar todas as tags válidas do HTML5. | [Link](https://youtube.com/playlist?list=PLx4x_zx8csUiVHRDO_7qhOaeNrrQ5uU8c) |
| HTML 5 Curso 2 | Curso de HTML5 + CSS3 + JavaScript completamente gratuito. Aulas criadas pelo professor Gustavo Guanabara. | [Link](https://youtube.com/playlist?list=PLHz_AreHm4dlAnJ_jJtV29RFxnPHDuk9o) |
| HTML5 & CSS3 na Prática | Um curso fantástico, que aborda de maneira simples e objetiva o processo de criação de uma página web em HTML5 e CSS3. Você aprenderá semântica, CSS produtivo e técnicas fundamentais para começar a trabalhar de forma mais ágil, ou seja, em “Design in the browser” (Desenhar no próprio browser). | [Link](https://www.youtube.com/playlist?list=PLwXQLZ3FdTVF_HYP5r1oR7vK1_7ZuTU78) |
| Rocketseat | Faça seu login na plataforma. | [Link](https://app.rocketseat.com.br/node/o-guia-estelar-de-html) |

## 🐍 Cursos de Python

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Aulas Python | Curso de aulas de programação usando a linguagem python, ensinando do básico ao profissional. | [Link](https://youtube.com/playlist?list=PLfCKf0-awunOu2WyLe2pSD2fXUo795xRe) |
| Curso de Python - Bro Code | Curso Completo de Python - Aprenda a codificar hoje (Free). | [Link](https://www.youtube.com/watch?v=XKHEtdqhLK8) |
| Curso de Python - freeCodeCamp.org | Aprenda Python - Curso Completo para Iniciantes (Tutorial). | [Link](https://www.youtube.com/watch?v=rfscVS0vtbw) |
| Curso de Python - freeCodeCamp.org | Python para todos - Curso completo de Python da universidade. | [Link](https://www.youtube.com/watch?v=8DvywoWv6fI) |
| Curso de Python - Programming with Mosh | Tutorial Python - Curso Completo de Python para Iniciantes. | [Link](https://www.youtube.com/watch?v=_uQrJ0TkZlc) |
| Curso de Python - TechWorld with Nana | Tutorial Python para Iniciantes - Aprenda Python em 5 horas (CURSO COMPLETO). | [Link](https://www.youtube.com/watch?v=t8pPdKYpowI) |
| Curso de Python 3 - Mundo 1: Fundamentos | Python é uma linguagem ultra moderna, utilizada pelo Google, YouTube, Industrial Light & Magic, Globo e muitas outras.  | [Link](https://www.youtube.com/playlist?list=PLHz_AreHm4dlKP6QQCekuIPky1CiwmdI6) |
| Curso de Python 3 - Mundo 2: Estruturas de Controle | Python é uma linguagem ultra moderna, utilizada pelo Google, YouTube, Industrial Light & Magic, Globo e muitas outras.  | [Link](https://www.youtube.com/playlist?list=PLHz_AreHm4dk_nZHmxxf_J0WRAqy5Czye) |
| Curso de Python 3 - Mundo 3: Estruturas Compostas | Python é uma linguagem ultra moderna, utilizada pelo Google, YouTube, Industrial Light & Magic, Globo e muitas outras.  | [Link](https://www.youtube.com/playlist?list=PLHz_AreHm4dksnH2jVTIVNviIMBVYyFnH) |
...
| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Curso de Ruby On Rails (49 aulas) | Ruby on Rails é um framework livre que promete aumentar velocidade e facilidade no desenvolvimento de sites orientados a banco de dados (database-driven web sites), uma vez que é possível criar aplicações com base em estruturas pré-definidas. | [Link](https://goo.gl/4oXEAP) |
| Curso de Ruby On-Rails - Codifike | Curso de Ruby on rails básico | [Link](https://youtube.com/playlist?list=PLFeyfVYazTkJN6uM5opCfSN_xjxrMybXV) |
| Curso de Ruby On-Rails - Danilo Aparecido | Linguagem Ruby | [Link](https://youtube.com/playlist?list=PLEdPHGYbHhldWUFs2Q-jSzXAv3NXh4wu0) |
| Curso de Ruby On-Rails - Jackson Pires | Curso de Ruby on Rails para Iniciantes | [Link](https://youtube.com/playlist?list=PLe3LRfCs4go-mkvHRMSXEOG-HDbzesyaP) |
| Curso de Ruby On-Rails (15 aulas) | Ruby é uma linguagem de programação interpretada multiparadigma, de tipagem dinâmica e forte, com gerenciamento de memória automático, originalmente planejada e desenvolvida no Japão em 1995, por Yukihiro "Matz" Matsumoto, para ser usada como linguagem de script. Matz queria uma linguagem de script que fosse mais poderosa do que Perl, e mais orientada a objetos do que Python.  | [Link](https://goo.gl/LcHcn4) |
| Introdução ao Ruby On-Rails | Curso completo de Ruby | [Link](https://youtube.com/playlist?list=PLdDT8if5attEOcQGPHLNIfnSFiJHhGDOZ) |

## 🍷 Cursos de Elixir

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Curso de Elixir | A linguagem criada pelo brasileiro José Valim vem crescendo e se destacando a cada ano, principalmente quando notamos sua presença no mercado da programação. | [Link](https://www.youtube.com/watch?v=GXlyLSVDkhI&list=PLydk1OOOmzo8VBeU334j4R4WvSByRNpXR&ab_channel=ELLYACADEMY) |
| Curso de Elixir - Adolfo Neto | Primeiros Passos, tipos básicos e operações básicas. | [Link](https://www.youtube.com/watch?v=2weVIXHyIwI&list=PLF5ttO8F-IsT42x53iFxOhmY70AWf-nd6&index=53&ab_channel=AdolfoNeto) |
| Curso de Elixir - Fernando Daciuk | Série "Aprenda com quem não sabe". | [Link](https://www.youtube.com/playlist?list=PLr4c053wuXU-YY4GmqUM3y_uauspsmO0O) |
| Curso de Elixir - Stone Tech | Get Started - Conhecendo o Elixir (Alquimia Stone 1.1). | [Link](https://www.youtube.com/watch?v=WRGvPgCHMfI&list=PLv3nyCBtlWP8I9rknIrfcJWrO05yEzknD&ab_channel=StoneTech) |
| Elixir in 100 Seconds | Elixir is a dynamic functional programming language built on top of the Erlang BEAM virtual machine. It is excels at building concurrent fault-tolerant applications at scale. | [Link](https://www.youtube.com/watch?v=R7t7zca8SyM) |
| Elixir4Noobs | Elixir4Noobs desenvolvido por aleDsz. | [Link](https://github.com/aleDsz/elixir4noobs) |
| ElixirSchool | Elixir School is the premier destination for people looking to learn and master the Elixir programming language. Whether you’re a seasoned veteran or this is your first time, you’ll find what you need in lessons and auxiliary resources. | [Link](https://elixirschool.com/pt) |

## 🌐 Cursos de React

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Curso de React.JS | Curso de ReactJS do João Ribeiro. | [Link](https://youtube.com/playlist?list=PLXik_5Br-zO9YVs9bxi7zoQlKq59VPTX1) |
| Curso de React.JS - Florin Pop | Movies App - React Project. | [Link](https://www.youtube.com/watch?v=sZ0bZGfg_m4) |
| Curso de React.JS - Florin Pop | Job Listing App - ReactJS and TailwindCSS Tutorial. | [Link](https://www.youtube.com/watch?v=JZQ8m08cbF0) |
| Curso Intensivo de Next JS e React | Aprenda os principais fundamentos e conceitos do NextJS, e desenvolva uma aplicação completa. | [Link](https://www.cod3r.com.br/courses/curso-intensivo-next-react) |
| Curso de React Native com Hooks e Context API - Cadastro Completo | Aprenda os fundamentos de React Native e crie um cadastro completo do zero. | [Link](https://www.cod3r.com.br/courses/react-native-crud) |

## 📱 Cursos de React Native

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Aprenda React Native | Nessa playlist sobre React Native você aprenderá desde o básico até técnicas avançadas para criar Apps Mobile utilizando o framework do facebook. | [Link](https://www.youtube.com/playlist?list=PL8fIRnD1uUSnRqz3E2caAWDqbtIFXmNtW) |
| Aulas React Native | Instalando as Ferramentas do React Native | [Link](https://www.youtube.com/playlist?list=PL69eBMqNvxhVer10WY3nxgV0qiO8xenOP) |
| Curso de React com Mysql - React Native | O curso completo de React Native com Mysql e PHP possui 43 aulas, neste curso é mostrado o passo a passo de como conectar os aplicativos android e ios criados pelo React com um banco de dados mysql usando apis em Mysql. | [Link](https://www.youtube.com/playlist?list=PLxNM4ef1BpxgALv5Vm-ooZo8qYRgCzKSV) |
| Curso de React Native - CFBCursos | Em nosso curso de React Native você irá aprender de forma objetiva e simples como criar aplicativos de celular para Android e iOS usando o mesmo código. | [Link](https://www.youtube.com/playlist?list=PLx4x_zx8csUgyDN7j9L7gykBjxByM_etD) |
| Curso de React Native - APP IOS e Android | O curso de React Native possui 35 aulas, este é um curso para iniciantes, para quem deseja ter seu primeiro contato com React voltado para o desenvolvimento de aplicativos mobile, mostro detalhadamente como instalar o React de forma simples e usar seus principais componentes. | [Link](https://www.youtube.com/playlist?list=PLxNM4ef1Bpxhe_PxwprF0R2fp0UurDZuw) |
| Curso de React Native - Developer Plus | Introdução ao React Native, explicando o que é React Native, sua origem e quais as principais vantagens. Assim como exemplos de aplicativos desenvolvidos com este framework. | [Link](https://www.youtube.com/playlist?list=PLxF2lyHGcERApnjQPgeeEIzJJdGurraMW) |
| Curso de React Native - Programador BR | Algumas pessoas pediram para fazer este passo-a-passo. | [Link](https://www.youtube.com/playlist?list=PLVzrOYTg7zYD__qifpofsQDhHVHEvSx_h) |
...
| Curso de Vue JS - Tutorial en Español | Curso de Vue JS desde cero para principiantes 💪, Aprende a trabajar con este hermoso framework de Javascript que es realmente poderoso. | [Link](https://www.youtube.com/playlist?list=PLPl81lqbj-4J-gfAERGDCdOQtVgRhSvIT) |
| Curso de Vuejs 2 - Completo | O VueJS é uma estrutura JavaScript progressiva usada para desenvolver interfaces da web interativas. | [Link](https://www.youtube.com/playlist?list=PLWhiA_CuQkbDxptXchXrYuGZnhlwnJgOF) |
| Curso Vue.js 3 desde cero | Curso del framework javascript Vue en su versión 3, desde nivel básico a avanzado. | [Link](https://www.youtube.com/playlist?list=PLYAyQauAPx8l7G8lTbSv23UTAwbVORY1r) |
| Vue js de 0 a 100 | En este tutorial vamos a hablar de vuejs, vamos a ver para que no nos sirve este framework, para que si, cuando si usarlos cuando no, también analizaremos su competencia (Angular JS y React JS).  | [Link](https://www.youtube.com/playlist?list=PLCTD_CpMeEKSiIog15wqiNOH52gYn42kW) |
| Vue.js do jeito ninja | Nessa série você vai aprender o básico do Vue.js e as suas principais funcionalidades como diretivas do tipo v-show, v-if, v-else, v-for, v-bind, eventos, filtros, componentes, slots, mixings, rota, Vue CLI e muito mais... | [Link](https://www.youtube.com/playlist?list=PLcoYAcR89n-qq1vGRbaUiV6Q9puy0qigW) |

## 🦂 Cursos de Svelte

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Curso de Svelte - Silvestre Vivo | Svelte tutorial en español | [Link](https://www.youtube.com/playlist?list=PLtEoLIi1AQhWzcCE76KQi4OLHqlDu_XUh) |
| Curso gratuito de Svelte | Descubre y aprende Svelte, un framework de frontend con la particularidad que tiene un paso de compilación. | [Link](https://www.youtube.com/playlist?list=PLV8x_i1fqBw2QScggh0pw2ATSJg_WHqUN) |
| Curso Intensivo de Svelte | Aprenda Svelte de forma super objetiva no desenvolvimento de uma aplicação. | [Link](https://www.cod3r.com.br/courses/svelte-intensivo) |
| Curso Svelte JS SPA + Store + Router + Firebase | Curso de Svelte JS, Aprende a utilizar el framework que no utiliza virtual DOM! una de las ventajas para hacer sitios web robustos o aplicaciones con alto desempeño. | [Link](https://www.youtube.com/playlist?list=PLPl81lqbj-4J6xcUu7SW4f3Y1ou8X8rRY) |

## 🤳 Cursos de Flutter

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Curso de Flutter - balta.io | Curso de Flutter: Criando seu primeiro App grátis | [Link](https://www.youtube.com/playlist?list=PLHlHvK2lnJndhgbqLl5DNEvKQg5F4ZenQ) |
| Curso de Flutter - ChiaTK | Curso Introducción a Flutter en Español | [Link](https://www.youtube.com/playlist?list=PLl_hIu4u7P677H9f6zPOHiOz2izkvQq2E) |
| Curso de Flutter - Deivid Willyan | Flutter - Curso Flutter Avançado - 2022 | [Link](https://www.youtube.com/playlist?list=PLRpTFz5_57cufduUDgiZZqA_k5Q7UV_50) |
| Curso de Flutter - Desenvolva um Cadastro Completo 2020 | Curso SUPER objetivo te ensinando como construir um Cadastro completo em Flutter! CRUD... Create, Read, Update e Delete. | [Link](https://www.cod3r.com.br/courses/flutter-desenvolva-um-cadastro-completo) |
| Curso de Flutter - Flutterando | Curso COMPLETO de Flutter | [Link](https://www.youtube.com/playlist?list=PLlBnICoI-g-d-J57QIz6Tx5xtUDGQdBFB) |
| Curso de Flutter - Hélio Kamakawa | Curso Flutter | [Link](https://www.youtube.com/playlist?list=PLg5-aZqPjMmBmCIgUZ0kNtoE7KJfvJZXS) |
| Curso de Flutter - Juliano Terterola | Cursos Flutter - Iniciante | [Link](https://www.youtube.com/playlist?list=PLrfnI95Js56bWvNYF5ItofdQy3aoJj4tQ) |
| Curso de Flutter - Prof. Diego Antunes | Curso de Flutter | [Link](https://www.youtube.com/playlist?list=PL_wKlpKIC9vWubXsj3IRPZ2Rk6QMfsPPg) |
| Curso de Flutter - Rodrigo Rahman | Curso Flutter para Iniciantes | [Link](https://www.youtube.com/playlist?list=PLEXr-WZRgPjwk2v5wYi70WN--pCGvN-9u) |
| Curso de FLUTTER e DART | Curso 100% gratuito de Flutter e Dart Completo.  | [Link](https://www.youtube.com/playlist?list=PL5EmR7zuTn_aX0pG4oWTyKKQT25Hkq2XG) |
| Flutter e Dart - Curso | Curso completo de Flutter e Dart. Nível iniciante, intermediário e avançado. | [Link](https://www.youtube.com/playlist?list=PLqdwHeoSjEN-9aGd-RxaS_2cyD_AKT0c_) |

## 🌕 Cursos de jQuery

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Curso Completo de jQuery (56 aulas) | O jQuery é um framework de Javascript de código aberto que possui licença dual, fazendo uso da Licença MIT ou da GNU General Public License versão 2. | [Link](https://goo.gl/tHdIZ7) |
| Curso de jQuery - Código Facilito | Curso jQuery - Código Facilito | [Link](https://www.youtube.com/playlist?list=PLTE0X123tz-yxigJHnmuEgqWeVMI7YI-W) |
| Curso de jQuery - Facultad Autodidacta | Curso de jQuery Basico | [Link](https://www.youtube.com/playlist?list=PLoRfWwOOv4jzx5mQTbL_un5KSFEAhkm8K) |
| Curso de jQuery - Jamilton Damasceno | Curso de jQuery | [Link](https://www.youtube.com/playlist?list=PLdrT3osfZM8wqtx9pEDyXmbn5NpSRSJOL) |
| Curso de jQuery - Java&Cia | Curso de JQuery (Universidade XTI). | [Link](https://www.youtube.com/playlist?list=PLxQNfKs8YwvGOv4evjpsB3JWWZnYChp04) |
| Curso de jQuery Básico | Curso passo a passo e completo de jQuery. Aprenda técnicas para implementar novos recursos e funcionalidades a suas aplicações Web. | [Link](https://www.youtube.com/playlist?list=PLIZ0d6lKIbVpF5DffKAX5e9L119PleIqg) |
| Curso de jQuery Completo | Parte I apresenta Introdução, Instalação, Filosofia e Organização da jQuery, Seletores (Simples, Hierárquicos, de Ordem, de Conteúdo, de Atributos e de Formulários). | [Link](https://www.youtube.com/playlist?list=PLcHPNq67CaVnHwfOeK9-7n57aOV6orMSO) |
| Jquery - Curso Completo em Português - (2018) | Curso de Jquery passo a passo do iniciante ao avançado. | [Link](https://www.youtube.com/playlist?list=PLB-cqguyT0racOkvxOYP6Am-Z0v7sdEcF) |

## 🐢 Cursos de Less

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Curso de Less (6 aulas) | LESS é uma linguagem de folha de estilos dinâmica desenhada por Alexis Sellier. | [Link](https://goo.gl/Y5UkLQ) |
| Curso de Less | O LESS é um pré-processador de CSS que permite uma folha de estilo personalizável, gerenciável e reutilizável para o site.  | [Link](https://www.youtube.com/playlist?list=PLWhiA_CuQkbBSfhS9nzc5BkopBY-22K-D) |
| Curso de Preprocesadores CSS: LESS | Los preprocesadores CSS han entrado con fuerza en el desarrollo front-end y cualquier profesional que trabaje con CSS debería utilizarlos, o por lo menos conocerlos. | [Link](https://www.youtube.com/playlist?list=PLwzKFCxxOMjPUOJitRL31rD1Zsd030sYX) |
| LESS de 0 a 100 | En este tutorial vamos a prender a instalar Less en nuestros proyectos web. | [Link](https://www.youtube.com/playlist?list=PLCTD_CpMeEKT70itw70uVs0vlFbvbCPQN) |

## 🐱 Cursos de Sass

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Aprenda SASS em 1 hora | Curso de SASS. Neste curso de SASS você vai aprender desde como instalar e criar um projeto com SASS e SCSS  | [Link](https://www.youtube.com/watch?v=Wo5t3uUV8n4) |
| Curso de Sass - Amanda Vilela | Curso Sass | [Link](https://www.youtube.com/playlist?list=PL97KElaimHeGRtfkksKwxg6IGVZi_cR7J) |
| Curso de Sass - FalconMasters | Curso Básico de SASS desde 0 | [Link](https://www.youtube.com/playlist?list=PLhSj3UTs2_yVyMlZyW-NAbgjtgAgLBzFP) |
| Curso de Sass - Tutoriales Front-End | Curso Básico de Sass | [Link](https://www.youtube.com/playlist?list=PL5mZlJHWhPyxKrfbsw5-1GxErJrOrSkWI) |
| Curso de Sass (18 aulas) /Inglês/ | Sass (Syntactically Awesome Stylesheets) é uma linguagem de script que é interpretada em CSS. SassScript é a própria linguagem de script. Sass consiste de duas sintaxes. A sintaxe original, chamada "a sintaxe recuada". | [Link](https://goo.gl/DzRv1e) |
| Curso de Sass | Curso Jornada Front-end no YouTube. Curso Iniciando com SASS no Front-end | [Link](https://www.youtube.com/playlist?list=PLMy95_4XE08OmaSd_GOLKNkqhoJFvg7w7) |
| Sass - Curso para principiantes desde cero | Sass con videos tutoriales de fácil comprensión, en este curso especializado en Sass te enseño a desarrollar las habilidades para que puedas manejar las características principales de Sass, así tu escritura de código CSS será cada vez más rápido y eficaz. | [Link](https://www.youtube.com/playlist?list=PLPl81lqbj-4I4VwUdjbV2iFg7wispiXKP) |
| SASS de 0 a 100 | En este tutorial vamos a descubrir que es SASS y para que nos sirve y en que nos facilita la vida, ademas de instalarlo en Windows 10. | [Link](https://www.youtube.com/playlist?list=PLCTD_CpMeEKQXywJB8KMN_-GccZuVf9ag) |

## 🤖 Cursos de Bootstrap

| Nome         | Descrição     | Site |
|--------------|-----------|------------|
| Criando um site com Bootstrap 4 | Faça o curso Criando um site com Bootstrap 4 e aprenda como criar um site utilizando os principais componentes do Bootstrap 4. | [Link](https://www.youtube.com/playlist?list=PLBbHLUbqqCrTwIrdix6kl84m4OPE0JexR) |
| Curso de Bootstrap - Aderson Jara | Curso Completo Bootstrap 2021 | [Link](https://www.youtube.com/playlist?list=PLsAGEZyePyj9_J7aj4oss5R1z6BlP9Jrv) |
| Curso de Bootstrap - Daniel Gimo | Curso de Bootstrap 4 para iniciantes | [Link](https://www.youtube.com/playlist?list=PLZOpILNI-A8kF_-OsviJK8-Saao7aAVaJ) |
| Curso de Bootstrap - Fazt | Curso de Bootstrap 4 | [Link](https://www.youtube.com/playlist?list=PLL0TiOXBeDagsYUYFO9WMwDtuDuoGZVB9) |
| Curso de Bootstrap - Jamilton Damasceno | Curso de Bootstrap 4 | [Link](https://www.youtube.com/playlist?list=PLdrT3osfZM8x7J_p0DI3r3WSfrvEc2ZWU) |
| Curso de Bootstrap - João Ribeiro | Bootstrap 5 Funtamental | [Link](https://www.youtube.com/playlist?list=PLXik_5Br-zO-iwhAe12sirOo_LZ0t-qEm) |
| Curso de Bootstrap - Matheus Battisti - Hora de Codar | Curso de Bootstrap | [Link](https://www.youtube.com/playlist?list=PLnDvRpP8Bnexu5wvxogy6N49_S5Xk8Cze) |
| Curso de Bootstrap - Vida FullStack | Curso de Bootstrap | [Link](https://www.youtube.com/playlist?list=PLMy95_4XE08Pr2_9gRnZ4niSgp00FgIHP) |
| Curso de Bootstrap - Way School | Curso Bootstrap para Inciantes | [Link](https://www.youtube.com/playlist?list=PL4fEIiChAHVvUZ4AphnSc5GdxL9s6yrnB) |
| Curso de Bootstrap (16 aulas) | O Bootstrap é uma estrutura de web front-end livre e de código aberto para projetar sites e aplicativos da web. | [Link](https://goo.gl/xFDOxT) |
| Curso de Bootstrap | Guia prático para utilização desta framework tão famosa no desenvolvimento de páginas e aplicações web. Um guia de acompanhamento para os conceitos expostos no website do Bootstrap. | [Link](https://www.youtube.com/playlist?list=PLXik_5Br-zO9pxSxRtgESquGT2OhR3o8B) |
| Curso de Bootstrap | O curso completo de Bootstrap possui 54 video aulas, contendo tudo sobre esse maravilhoso recurso de estilização de páginas web, neste curso pegamos todas suas classes e elementos que podem ser aplicados nas páginas web. | [Link](https://www.youtube.com/playlist?list=PLxNM4ef1BpxjV5B9tXA7D7_4Ovp_k_2lB) |
| Curso de Bootstrap 4 | Assim que for lançada a versão 5, colocaremos no ar. | [Link](https://www.youtube.com/playlist?list=PLxIWikUsH2nQcHKUTu8S7cNTzqT-_HOr4) |
| Curso de Bootstrap 4 | O curso completo de Bootstrap 4 possui 44 aulas, neste curso o aluno aprenderá a usar bootstrap para poder utilizar em sites, sistemas web, aplicativos e muito mais, atualmente todas as plataformas utilizam bootstrap para estilização. | [Link](https://www.youtube.com/playlist?list=PLxNM4ef1BpxjYsjQCzv_POTOssvR1zL2L) |
...
- [Git CheatSheet](https://training.github.com/downloads/pt_BR/github-git-cheat-sheet.pdf)<br>
  ...
  <details>
    <summary>📝 Git e Git Flow Cheat Sheet</summary>
    <hr>
